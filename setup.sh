...
IZIN=$( curl https://raw.githubusercontent.com/zairulhyuk/premvps/patch-1/ipvps.conf | grep $MYIP )
if [ $MYIP = $IZIN ]; then
...
#install ssr
wget https://raw.githubusercontent.com/gilagajet/premvps/main/ssr.sh && chmod +x ssr.sh && screen -S ssr ./ssr.sh
wget https://raw.githubusercontent.com/gilagajet/premvps/main/sodosok.sh && chmod +x sodosok.sh && screen -S ss ./sodosok.sh
#installwg
wget https://raw.githubusercontent.com/gilagajet/premvps/main/wg.sh && chmod +x wg.sh && screen -S wg ./wg.sh
#install v2ray
wget https://raw.githubusercontent.com/gilagajet/premvps/main/ins-vt.sh && chmod +x ins-vt.sh && screen -S v2ray ./ins-vt.sh
#install L2TP
#wget https://raw.githubusercontent.com/gilagajet/premvps/main/ipsec.sh && chmod +x ipsec.sh && screen -S ipsec ./ipsec.sh
#wget https://raw.githubusercontent.com/gilagajet/premvps/main/set-br.sh && chmod +x set-br.sh && ./set-br.sh
# set time GMT +8
